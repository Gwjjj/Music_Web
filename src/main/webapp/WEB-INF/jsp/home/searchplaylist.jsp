...
<jsp:include page="/header.jsp"></jsp:include>
	<ul class="nav nav-pills">
		...
		<li role="presentation" class="active"><a href="#">歌单</a></li>
	</ul>
					...
					<div id="page-content" class="box">
						...
						<div id="jpage" class="jpage box">
							...
							<div class="list box text-shadow" data-type="content">
								<c:forEach items="${playlistDetailsList}" var="playlistDetail"
									varStatus="status">
									<div class="list-item box">
										<!-- img -->
										<div class="img left">
											<img
												src="${pageContext.request.contextPath }/images/playlist/${ playlistDetail.playlistImg}.jpg"
												style="cursor: pointer;"
												onclick="playlistToRadio(${ playlistDetail.playlistId})" alt=""
												title="" />
										</div>
										<!-- data -->
										<div class="block right">
											<p class="date">
												<fmt:formatDate value="${playlistDetail.playlistCret}"
													pattern="yyyy-MM-dd HH:mm:ss" />
											</p>
											<p class="title">${playlistDetail.playlistName}</p>
											<p class="desc">${playlistDetail.playlistInfo}</p>
											<p class="like">${playlistDetail.playlistHot} Likes</p>
										</div>
									</div>
								</c:forEach>
							</div>
